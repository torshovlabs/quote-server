...
* The original package name 'com.torshovlabs.crypto-payment' is invalid and this project uses 'com.torshovlabs.quote' instead.
...
* [Spring Batch](https://docs.spring.io/spring-boot/3.5.0-SNAPSHOT/how-to/batch.html)
